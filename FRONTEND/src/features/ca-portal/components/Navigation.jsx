        ...
        <>
          ...
          <div className="fixed top-[88px] left-0 right-0 bottom-0 bg-white z-[998] overflow-y-auto lg:hidden">
            <div className="px-4 py-3 space-y-1">
              ...
              {/* Standalone link in mobile menu */}
              <div className="border-b border-gray-100">
                <button
                  ...
                  className="w-full flex items-center justify-between px-3 py-3.5 font-bold text-base text-[#F97316] hover:bg-orange-50 rounded-xl transition-all active:scale-95 cursor-pointer"
                >
                  <span className="flex items-center gap-2">
                    <span>🏢</span>
                    Virtual Office
