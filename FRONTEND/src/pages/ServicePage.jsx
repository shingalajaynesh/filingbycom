          ...
          <div className="lg:col-span-2">
            ...
            <article className="mt-6 rounded-3xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
              ...
              <div className="mt-5 space-y-3">
                {[
                  [`How long does ${found.item.label} take?`, 'Typically 3–7 working days depending on government processing time.'],
                  ['What is the government fee?', 'Government fee varies by state and business type. Our team will inform you before proceeding.'],
                  ['Is this 100% online?', 'Yes, the entire process is done online. No physical visits are required.'],
                ].map(([question, answer], index) => (
                  <div key={question} className="rounded-2xl border border-gray-100 bg-slate-50 p-4">
                    ...
                    {openFaq === index && <p className="mt-3 text-sm text-gray-600">{answer}</p>}
                  </div>
                ))}
              </div>
            </article>
